...
if __name__ == "__main__":
    ...
    print_report("DAY MODE A (Threaded + Batched)", f_a, t_a, m_a)
    
    f_b, t_b, m_b = run_multiprocessing_mode(VIDEO_FILES, TEST_DURATION)
    print_report("DAY MODE B (Multiprocessing)", f_b, t_b, m_b)
    
    f_c, t_c, m_c = run_queue_mode(VIDEO_FILES, TEST_DURATION)
    print_report("DAY MODE C (Threaded Queues)", f_c, t_c, m_c)
