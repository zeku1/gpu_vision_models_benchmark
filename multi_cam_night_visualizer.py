...
if __name__ == "__main__":
    ...
    print("Starting Night Tiled Visualizer (3x2). Press 'q' to quit.")
    cv2.namedWindow("Night-time 5-Camera Dashboard", cv2.WINDOW_NORMAL)
