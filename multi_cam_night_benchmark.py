...
if not VIDEO_FILES:
    print(f"Error: No video samples found in {SAMPLES_DIR}. Please add 5 night video files.")
    exit(1)
...
def run_queue_mode(video_paths, duration=30):
    ...
    consumers = [threading.Thread(target=consumer) for _ in range(3)] # 3 consumers for 5 cams
